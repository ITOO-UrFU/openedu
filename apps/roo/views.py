...
def TableCourseUpdate(request):
    if request.method == "POST":
        ...
        course.record_end_at = request.POST['record_end_at']
        course.title = request.POST['title']
        course.image = request.POST['image']
        course.created_at = request.POST['created_at']
        course.visitors_rating = request.POST['visitors_rating']
        course.duration = request.POST['duration']
        course.finished_at = request.POST['finished_at']
        course.competences = request.POST['competences']
        course.accreditation = request.POST['accreditation']
        course.description = request.POST['description']
        course.expert_rating_count = request.POST['expert_rating_count']
        course.has_sertificate = request.POST['has_sertificate']
        course.language = request.POST['language']
        course.course_item_url = request.POST['course_item_url']
        course.content = request.POST['content']
        course.started_at = request.POST['started_at']
        course.rating = request.POST['rating']
        course.external_url = request.POST['external_url']
        course.lectures_number = request.POST['lectures_number']
        course.version = request.POST['version']
        course.visitors_rating_count = request.POST['visitors_rating_count']
        course.total_visitors_number = request.POST['total_visitors_number']
        course.experts_rating = request.POST['experts_rating']
        course.requirements = request.POST['requirements']
        course.cabinet_course_url = request.POST['cabinet_course_url']
        course.admin_email = request.POST['admin_email']
        course.newest = request.POST['newest']
        course.expert_account = request.POST['expert_account']
        course.communication_owner = request.POST['communication_owner']
        course.communication_platform = request.POST['communication_platform']
        course.expertise_status = request.POST['expertise_status']
        course.passport_status = request.POST['passport_status']
        course.roo_status = request.POST['roo_status']
        course.required_ratings_state = request.POST['required_ratings_state']
        course.unforced_ratings_state = request.POST['unforced_ratings_state']
        course.comment = request.POST['comment']
        course.expert_access = request.POST['expert_access']
        course.reg_data = request.POST['reg_data']
        course.contacts = request.POST['contacts']
        course.platform_responsible = request.POST['platform_responsible']
        course.owner_responsible = request.POST['owner_responsible']
        course.responsible_comment = request.POST['responsible_comment']
        course.passport_responsible = request.POST['passport_responsible']
        course.save()
        return JsonResponse({"status": "sucess"})
    else:
