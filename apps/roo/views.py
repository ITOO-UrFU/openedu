...
def TableCourseUpdate(request):
    if request.method == "POST":
        ...
        course.record_end_at = request.POST.get('record_end_at')
        course.title = request.POST.get('title')
        course.image = request.POST.get('image')
        course.created_at = request.POST.get('created_at')
        course.visitors_rating = request.POST.get('visitors_rating')
        course.duration = request.POST.get('duration')
        course.finished_at = request.POST.get('finished_at')
        course.competences = request.POST.get('competences')
        course.accreditation = request.POST.get('accreditation')
        course.description = request.POST.get('description')
        course.expert_rating_count = request.POST.get('expert_rating_count')
        course.has_sertificate = request.POST.get('has_sertificate')
        course.language = request.POST.get('language')
        course.course_item_url = request.POST.get('course_item_url')
        course.content = request.POST.get('content')
        course.started_at = request.POST.get('started_at')
        course.rating = request.POST.get('rating')
        course.external_url = request.POST.get('external_url')
        course.lectures_number = request.POST.get('lectures_number')
        course.version = request.POST.get('version')
        course.visitors_rating_count = request.POST.get('visitors_rating_count')
        course.total_visitors_number = request.POST.get('total_visitors_number')
        course.experts_rating = request.POST.get('experts_rating')
        course.requirements = request.POST.get('requirements')
        course.cabinet_course_url = request.POST.get('cabinet_course_url')
        course.admin_email = request.POST.get('admin_email')
        course.newest = request.POST.get('newest')
        course.expert_account = request.POST.get('expert_account')
        course.communication_owner = request.POST.get('communication_owner')
        course.communication_platform = request.POST.get('communication_platform')
        course.expertise_status = request.POST.get('expertise_status')
        course.passport_status = request.POST.get('passport_status')
        course.roo_status = request.POST.get('roo_status')
        course.required_ratings_state = request.POST.get('required_ratings_state')
        course.unforced_ratings_state = request.POST.get('unforced_ratings_state')
        course.comment = request.POST.get('comment')
        course.expert_access = request.POST.get('expert_access')
        course.reg_data = request.POST.get('reg_data')
        course.contacts = request.POST.get('contacts')
        course.platform_responsible = request.POST.get('platform_responsible')
        course.owner_responsible = request.POST.get('owner_responsible')
        course.responsible_comment = request.POST.get('responsible_comment')
        course.passport_responsible = request.POST.get('passport_responsible')
        course.save()
        return JsonResponse({"status": "sucess"})
    else:
